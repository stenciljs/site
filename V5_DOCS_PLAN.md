...
See the expanded content item in §5 for where this goes structurally. **Not yet drafted** — this needs the slot-mechanics verification above before writing anything that asserts specific behavior.
