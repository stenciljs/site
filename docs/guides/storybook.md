...
To do this, you can embed the [Stencil Loader](../output-targets/loader-bundle.md#importing-with-a-bundler) in the Storybook preview script to **lazily register all components** globally:
