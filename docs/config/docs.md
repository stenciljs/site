...
The `docs` config option allows global configuration of certain behaviors related to [documentation generation output targets](../output-targets/documentation-generation/01-overview.md).
...
The `markdown` config object allows certain customizations for markdown files generated by the [`docs-readme` output target](../output-targets/documentation-generation/docs-readme.md) or the
`--docs` CLI flag.
